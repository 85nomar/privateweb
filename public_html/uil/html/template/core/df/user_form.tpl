...
<div class="span12" id="content">
    ...
    <form class="form-horizontal" action="{$strFormAction}" method="POST">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="password" id="strPassword" name="strPassword" maxlength="{$larrDaten.strPasswordMaxLength}" value="{$larrDaten.strPassword}">
            ...
            <div class="controls">
                {foreach $larrDaten.larrRollen AS $larrRolle}
                    <label class="checkbox">
                        <input id="strRoll[]" name="arrRoll[]" type="checkbox" value="{$larrRolle.numRollID}" {if $larrRolle.selected}checked{/if}>{$larrRolle.strName}
                    </label>
                {/foreach}
            </div>
        </div>
