...
(function (a, b) {
    ...
    function e(a, e) {
        c.addType(a, function (f, g, h) {
            ...
            if (g === b) {
                ...
                if (j.expires && j.expires <= n)e.removeItem(f); else return j.data
            } else if (g === null)e.removeItem(f); else {
        ...
        if (!c.types.localStorage) {
            ...
            c.addType("userData", function (e, f, g) {
                ...
                if (f === b) {
                    ...
                    if (i.expires && i.expires <= n)a.removeAttribute(e); else return i.data
    ...
    a.request = function (b, f, g) {
        ...
        if (!a.publish("request.before", h))h.error(null, "abort"); else {
